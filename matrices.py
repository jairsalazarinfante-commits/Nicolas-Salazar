...
Permite al usuario ingresar matrices y realizar operaciones como:
- Suma
- Resta
- Multiplicación
...
def ingresar_matriz(nombre=""):
    """Solicita al usuario ingresar una matriz."""
...
def mostrar_matriz(matriz, nombre="Resultado"):
    """Muestra una matriz con formato en la consola."""
...
def mostrar_vector(vector, titulo="Vector"):
    """Muestra un vector con formato en la consola."""
    elementos = []
    for x in vector:
        if x == int(x):
